...
public static class IconPaths
{
    ...
    // TODO(asset): add Assets/Icons/ai/upscale.ico. Until then the header/menu fall back to the generic FrameShift AI icon.
    public static string UpscaleAiIcon => Combine("ai", "upscale.ico");
