...
public sealed class CompressAudioForm : Form
{
    ...
    public CompressAudioForm(string sourcePath, string sourceExtension, long sourceBytes, int sampleRate, int channels)
    {
        ...
        var audioInfo = FormatAudioInfo(sampleRate, channels);
        var header = CreateHeader(sourcePath, sourceExtension, sourceBytes, audioInfo);
        Controls.Add(header);
        ...
        _checkTarget = new CheckBox
        {
            ...
            ForeColor = _targetSizeSupported ? FrameShiftTheme.TextPrimary : FrameShiftTheme.TextMuted,
            FlatStyle = FlatStyle.Standard,
            Enabled = _targetSizeSupported
        };
        ...
        _textTarget.Enabled = _targetSizeSupported;
        ...
        _unitSelector.Enabled = _targetSizeSupported;
        targetSection.Controls.Add(_unitSelector);

        var targetHintText = _targetSizeSupported
            ? "Best-effort target"
        ...
        var infoLabel = new Label
        {
            ...
            Text = "The compressed audio is created next to the original file. The format stays the same.",
